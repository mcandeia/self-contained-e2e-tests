...
load('./modules/k6.Tiltfile', 'k6_local_resource')
load('./modules/dapr.Tiltfile', 'dapr_helm_resource', 'component_create',  'with_annotations')
...
k6_local_resource(run_grafana=cfg[run_grafana_config], add_prometheus=cfg[add_prometheus_config])
dapr_helm_resource(version=cfg[dapr_version_config])
